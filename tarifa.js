...
// 3. Una vez obtenido el monto del pago por consumo mostrar al usuario este mensaje por consola:“Debido a que su hogar tuvo un consumo de 450kwh, en base al ajuste tarifario (hogares con consumo mayor a 300kwh por mes tendrán un aumento del 20%), cumplimos con informarle que se ha ajustado el total a pagar, que será de $14400”

let pagoMes = 12000;
let consumpKWH = 450;

let aumentoMes = pagoMes*1.20;

let incremento = (consumpKWH > 300) ? console.log(`Debido a que su hogar tuvo un consumo de ${consumpKWH}kwh, en base al ajuste tarifario (hogares con consumo mayor a 300kwh por mes tendrán un aumento del 20%), cumplimos con informarle que se ha ajustado el total a pagar, que será de $${aumentoMes}`) : "";